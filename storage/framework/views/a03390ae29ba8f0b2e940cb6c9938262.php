        ...
        <nav class="navbar navbar-expand-md navbar-light bg-white shadow-sm">
            <div class="container">
                <a class="navbar-brand" href="<?php echo e(url('/')); ?>">
                    <img src="<?php echo e(asset('img/logo.png')); ?>" alt="" width="50" height="44">
                    ZAHRA LAUNDRY
                </a>
                    ...
                    <ul class="nav nav-pills">
                        ...
                        <ul class="nav nav-underline">
                            <li class="nav-item">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" href="<?php echo e(url('/paket')); ?>">Data Paket</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="<?php echo e(url('/konsumen')); ?>">Data Konsumen</a>
                                </li>
                                <li class="nav-item">
...
<?php /**PATH C:\xampp\htdocs\pbwl-uas-mayang\resources\views/layouts/app.blade.php ENDPATH**/ ?>